...
st.sidebar.markdown('''
    ...
    To learn more about DOL data, visit the [Open Data Portal](https://www.dataportal.dol.gov).
...
st.sidebar.markdown('[**Contact DOL**](https://dataportal.dol.gov/contact-us) for questions or assistance.', unsafe_allow_html=True)        
